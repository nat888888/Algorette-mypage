    ...
    const initAnimations = () => {
      ...
      if (window.gsap) {
        ...
        const ctx = gsap.context(() => {
          ...
          const danceSection = document.querySelector("#scene-dance");
          if (danceSection) {
            ScrollTrigger.create({
              ...
              onEnter: () => {
                danceSection.classList.add("spotlight-active");
                gsap.to(danceSection, {
                  "--spotlight-x": "50%",
                  "--spotlight-y": "50%",
                  duration: 1,
                  ease: "power2.out"
              ...
              onLeave: () => {
                danceSection.classList.remove("spotlight-active");
              },
              onEnterBack: () => {
                danceSection.classList.add("spotlight-active");
                gsap.to(danceSection, {
  ...
  return (
    <>
      <main>
        ...
        {/* SCENE 3-2: TRAVEL */}
        <section id="scene-travel" className="scene cursor-paper-airplane">
            <div className="w-full h-screen content-wrapper">
